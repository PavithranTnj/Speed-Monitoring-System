...
def model_predict(img_path, model):
    ...
    labels = ["30KM Speed","60KM Speed","Speed Break","School Zone","80KM Speed","No Sound Zone","No Parking","Pedestrian","Road Work","Train Track"]
...
root = Tk()
root.title("Speed Monitoring System")
...
result_label = Label(root, text="", font=("Helvetica", 16),fg="#ff4d4d",bg="#f2f2f2")
result_label.pack(pady=20)

# Button to select image
select_button = Button(root, text="Select Image", command=select_image, font=("Helvetica", 14),bg="#ffcc00",fg="black",activebackground="#ffd633",activeforeground="black",relief="raised")
select_button.pack(pady=10)

# Button to capture image from the camera
capture_button = Button(root, text="Capture Image", command=capture_image_with_delay, font=("Helvetica", 14),bg="#00cc66",fg="white",activebackground="#33d98e",activeforeground="white",relief="raised")
